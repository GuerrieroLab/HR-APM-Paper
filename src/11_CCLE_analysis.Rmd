...
h3(mean.c.all,Colv=NA,Rowv=NA,scale="none",#balanceColor=TRUE,
   ...
   ColSideColors=cbind(conserved=int.lc[1:3]),RowSideColors=cbind(conserved=int.lc[1:3]))
dev.off()
...
pdf(file=file.path(fig_dir1,"ccle_heatmap_all.pdf"),width=7,height=7)
...
pdf(file=file.path(fig_dir1,"ccle_heatmap_luminal.pdf"),width=7,height=7)
