...
```{r}
# Load required data
load(file.path(obj_dir, "1-4_prep", "tcga_processed_v3.rda"))
load(file.path(obj_dir, "1-4_prep", "metabric_processed_v3.rda"))
load(file.path(obj_dir, "1-4_prep", "tcga_metabric_cors.rda"))
load(file.path(obj_dir, "1-4_prep", "heatmap_sidecols.rda"))

tested.gns <- intersect(tcga.syms, meta.syms)
sigs <- readRDS(file.path(obj_dir, "1-4_prep", "modules3_ers_immune_cc.rds"))
...
```{r}
xx <- source(file.path(src_dir,"utils","subtype_violin_plot.R"))
```


```{r}
p <- subtype_violin_within(dfx=dfx.tcga,mod="ERS") + ggtitle("ERS (TCGA)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","tcga_ers_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_within(dfx=dfx.tcga,mod="IMMUNE") + ggtitle("Pan-immune (TCGA)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","tcga_imms_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_within(dfx=dfx.tcga,mod="TNFA.NFKB") + ggtitle("TNFa/NFkB (TCGA)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","tcga_imm1_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_within(dfx=dfx.tcga,mod="IFN.I") + ggtitle("IFN-I (TCGA)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","tcga_imm2_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_within(dfx=dfx.tcga,mod="APM.TC") + ggtitle("APM/TC (TCGA)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","tcga_imm3_v2.pdf"),width=3,height=6)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_violin_bc_subtypes","tcga_ers_imm1_v2.pdf"),width=3,height=6)
print(p)
dev.off()
...
pdf(file.path(fig_dir,"6_violin_bc_subtypes","tcga_ers_imm2_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_between(dfx=dfx.tcga,mod="APM.TC") + ggtitle("ERS vs APM/TC (TCGA)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","tcga_ers_imm3_v2.pdf"),width=3,height=6)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_violin_bc_subtypes","meta_ers_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_within(dfx=dfx.meta,mod="IMMUNE") + ggtitle("Pan-immune (METABRIC)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","meta_imms_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_within(dfx=dfx.meta,mod="TNFA.NFKB") + ggtitle("TNFa/NFkB (METABRIC)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","meta_imm1_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_within(dfx=dfx.meta,mod="IFN.I") + ggtitle("IFN-I (METABRIC)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","meta_imm2_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_within(dfx=dfx.meta,mod="APM.TC") + ggtitle("APM/TC (METABRIC)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","meta_imm3_v2.pdf"),width=3,height=6)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_violin_bc_subtypes","meta_ers_imm1_v2.pdf"),width=3,height=6)
print(p)
dev.off()
...
pdf(file.path(fig_dir,"6_violin_bc_subtypes","meta_ers_imm2_v2.pdf"),width=3,height=6)
print(p)
dev.off()

p <- subtype_violin_between(dfx=dfx.meta,mod="APM.TC") + ggtitle("ERS vs APM/TC (METABRIC)")
pdf(file.path(fig_dir,"6_violin_bc_subtypes","meta_ers_imm3_v2.pdf"),width=3,height=6)
print(p)
dev.off()
```
...
```{r}
xx <- source(file.path(src_dir,"utils","plot_module_scores.R"))
```


### [Fig S2E] METABRIC
```{r}
ers.exp <- meta.m3[match("ESR1",meta.syms),unlist(meta.ids[c("hr","dp","tnbc","her2")])]
cls <- factor(rep(subtypes,sapply(meta.ids[c("hr","dp","tnbc","her2")],length)),
	levels=subtypes)
...
if(0){
  # save(lst.tcga.gs,lst.meta.gs,file=file.path(obj_dir,"1-4_prep","tcga_meta_ssgsea_scores_v2.rda"))
  save(lst.tcga.gs,lst.meta.gs,file=file.path(obj_dir,"1-4_prep","tcga_meta_ssgsea_scores_zscore.rda"))  
}else{
  x <- load(file.path(obj_dir,"1-4_prep","tcga_meta_ssgsea_scores_zscore.rda"))  
}
```
...
##
pdf(file.path(fig_dir,"2_prep_tcga","tcga_ers_vs_cc_hr.pdf"),width=7,height=7)
par(mar=c(5,5,3,3))
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_violin_esr1.pdf"),width=4,height=8)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_esr1_vs_ers_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_imm1_vs_imm3_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_imm2_vs_imm3_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_imm1_vs_imm2_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_violin_imm.pdf"),width=5,height=7)
print(p)
dev.off()
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_ers_vs_imm1_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_ers_vs_imm2_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","tcga_ers_vs_imm3_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_violin_esr1.pdf"),width=4,height=8)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_esr1_vs_ers_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_imm1_vs_imm3_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_imm2_vs_imm3_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_imm1_vs_imm2_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_violin_imm.pdf"),width=5,height=7)
print(p)
dev.off()
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_ers_vs_imm1_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_ers_vs_imm2_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
...
pdf(file.path(fig_dir,"6_heatmap_bc_subtypes","activity_plot","meta_ers_vs_imm3_v3.pdf"),width=7,height=7)
print(p)
dev.off()
```
