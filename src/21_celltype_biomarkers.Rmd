...
### DF/BCC data
```{r}
wp <- readRDS(file=file.path(obj_dir,"DFBCC_sn","seurat_harmony_v2.rds"))
...
saveRDS(markers.d,file=file.path(obj_dir,"DFBCC_sn","markers_all_dfci_102824.rds"))
```
...
```{r}
markers.d <- readRDS(file=file.path(obj_dir,"DFBCC_sn","markers_all_dfci_102824.rds"))
...
##
saveRDS(markers.wd,file=file.path(obj_dir,"DFBCC_sn","markers_all_wehi_dfci_102824.rds"))
...
saveRDS(lst.wd,file=file.path(obj_dir,"DFBCC_sn","list_biomarkers_102824.rds"))
```
